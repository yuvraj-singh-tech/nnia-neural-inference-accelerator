...
Role in Pipeline
----------------
- Connects all NNIA datapath and control modules
- Coordinates tiled computation flow across the full system
- Provides final output assembly and status signaling
------------------------------------------------------------------------------
*/
...
module top_nnia #(
    ...
    localparam integer CONTROLLER_DRAIN_CYCLES = ((ROWS - 1) + (COLS - 1));
